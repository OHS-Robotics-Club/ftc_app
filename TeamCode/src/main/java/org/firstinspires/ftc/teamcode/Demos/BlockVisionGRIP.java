...
public class BlockVisionGRIP extends OpenCVPipeline {
    @Override
    ...
    public void process(Mat source0) {
        ...
        double[] hsvThresholdHue = {0.0, 56.230899830220714};
        ...
        double[] filterContoursSolidity = {91.72661870503596, 100};
        ...
        if (true) {
            ...
            Imgproc.drawContours(resizeImageOutput, filterContoursOutput, -1, new Scalar(0, 255, 0), 2, 8);
        }
    }
    ...
    private void hsvThreshold(Mat input, double[] hue, double[] sat, double[] val,
                              Mat out) {
        Imgproc.cvtColor(input, out, Imgproc.COLOR_RGB2HSV, 3);
